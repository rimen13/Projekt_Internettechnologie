...
\def\dy{2.5}       % vertikaler Versatz der Pfade
...
Für eine einfachere Bearbeitung dieses Projekts und zur Versionskontrolle wurde ein \textit{GitHub-Repository} erstellt. Dieses vereinfacht insbesondere die Zusammenarbeit mehrerer Teilnehmer und ist unter dem Link \textit{https://github.com/rimen13/Projekt\_Internettechnologie} erreichbar. Das \textit{Repository} enthält alle angehängten Dateien und ermöglicht den Zugriff auf ältere Zwischenstände. \autoref{fig:projektordnerstruktur} die Struktur der angehängten Dateien, welche aus dem GitHub-Repository hervorgeht.

Für dieses Projekt Moodle-Unterlagen für das Modul Internettechnologien verwendet. Für die Preise und Stückzahlen der einzelnen elektronischen Bauteile in der XML-Datei wurden die Websiten \textit{https://www.digikey.de} und \textit{https://www.mouser.de} herangezogen.
