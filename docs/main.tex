...
In \autoref{tab:Dateiübersicht} sind alle Dateien dargestellt, die die Daten selbst abbilden, Transformationen ermöglichen oder Ergebnisse der Transformationen sind.
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \caption{Dateiübersicht}
    \label{tab:Dateiübersicht}
\end{table}
